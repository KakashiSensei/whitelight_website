...
var GameHeader = function (_Component) {
    _inherits(GameHeader, _Component);

    function GameHeader(props) {
        _classCallCheck(this, GameHeader);

        return _possibleConstructorReturn(this, (GameHeader.__proto__ || Object.getPrototypeOf(GameHeader)).call(this, props));
    }

    _createClass(GameHeader, [{
        key: "render",
        value: function render() {
            var imageURL = this.props.introImage;
            var title = this.props.title;
            var website = this.props.url;
            return _react2.default.createElement(
                ...
                _react2.default.createElement("meta", { name: "description", content: title }),
                ...
                _react2.default.createElement("meta", { property: "og:url", content: website }),
